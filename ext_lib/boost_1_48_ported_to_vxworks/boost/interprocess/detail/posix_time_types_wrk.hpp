...
#else
#warning  "compile with second clock as if micro seconds clock (lack resolution)"
typedef boost::date_time::second_clock<boost::posix_time::ptime>  microsec_clock; // we dont have good resolution..
