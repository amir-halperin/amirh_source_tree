...
class message_queue_t
{
   ...
   typedef typename boost::pointer_to_other2<void_pointer, char>::type  char_ptr;
...
class msg_hdr_t 
{
   ...
   typedef typename boost::
      pointer_to_other2<VoidPointer, char>::type                          char_ptr;
   typedef typename std::iterator_traits<char_ptr>::difference_type       difference_type;
   typedef typename boost::make_unsigned<difference_type>::type           size_type;
...
{
   typedef typename boost::
      pointer_to_other2<VoidPointer, msg_hdr_t<VoidPointer> >::type      msg_hdr_ptr_t;
...
{   
   ...
   typedef typename boost::
      pointer_to_other2<void_pointer, msg_header>::type                   msg_hdr_ptr_t;
   typedef typename std::iterator_traits<msg_hdr_ptr_t>::difference_type  difference_type;
   typedef typename boost::make_unsigned<difference_type>::type           size_type;
   typedef typename boost::
      pointer_to_other2<void_pointer, msg_hdr_ptr_t>::type                msg_hdr_ptr_ptr_t;
...
{
   public:
   typedef typename boost::pointer_to_other2<VoidPointer, char>::type   char_ptr;
   typedef typename std::iterator_traits<char_ptr>::difference_type    difference_type;
   typedef typename boost::make_unsigned<difference_type>::type        size_type;
