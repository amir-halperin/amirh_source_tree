...
struct pointer_to_other2;

template<class T, class T2, class T3, size_t A, class U, 
         template<class, class, class, size_t A> class Sp>
struct pointer_to_other2< Sp<T, T2, T3, A>, U >
{
   typedef Sp<U, T2, T3, A> type;
};
