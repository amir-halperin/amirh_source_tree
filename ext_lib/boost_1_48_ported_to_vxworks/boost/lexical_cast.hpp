...
# pragma option pop
    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace)
        {
            using namespace std;
#ifndef BOOST_LCAST_NO_WCHAR_T
           typedef wchar_t char_lookup_t;
#else
           typedef char char_lookup_t;
#endif  // #ifndef BOOST_LCAST_NO_WCHAR_T
            const char_lookup_t minus = lcast_char_constants<char_lookup_t>::minus;
            const char_lookup_t plus = lcast_char_constants<char_lookup_t>::plus;
