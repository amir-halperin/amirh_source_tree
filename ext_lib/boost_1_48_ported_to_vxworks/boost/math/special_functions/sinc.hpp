    ...
    namespace math
    {
       namespace detail
       {
        ...
        inline T    sinc_pi_imp(const T x)
        {
            ...
            if    (impl_abs_value<T>::get(x) >= taylor_n_bound)
            {
                return(sin(x)/x);
            }
            else
            {
                ...
                if    (impl_abs_value<T>::get(x) >= taylor_0_bound)
                {
                    T    x2 = x*x;
                    ...
                    if    (impl_abs_value<T>::get(x) >= taylor_2_bound)
                    {
       ...
       inline typename tools::promote_args<T>::type sinc_pi(T x, const Policy&)
       {
        ...
        inline U<T>    sinc_pi(const U<T> x)
        {
            ...
            if    (boost::math::detail::impl_abs_value<T>::get(x) >= taylor_n_bound)
            {
                return(sin(x)/x);
            }
            else
            {
                ...
                if    (boost::math::detail::impl_abs_value<T>::get(x) >= taylor_0_bound)
                {
                    U<T>    x2 = x*x;
                    ...
                    if    (boost::math::detail::impl_abs_value<T>::get(x) >= taylor_2_bound)
                    {
                        // approximation by taylor series in x at 0 up to order 4
                        result += (x2*x2)/static_cast<T>(120);
                    }
