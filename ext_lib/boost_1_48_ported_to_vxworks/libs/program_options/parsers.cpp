...
#include <crtl.h>
#else
#if !defined(_WIN32) || defined(__COMO_VERSION__) || defined(__VXWORKS__)
// HF_TODO please note that I don't think it would work for vxworks, but at least it would pass linkage
extern char** environ;
#endif
#endif
#endif
...
#else
# warning "would not support function parse_environment under vxworks"
#endif  // __VXWORKS__
        return result;
    }
