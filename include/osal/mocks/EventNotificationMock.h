#pragma once
/**
 * @brief This file contain mock class definition to be used inside unit testing that uses event notification
 * 
...
class EventNotificationMock
{
public:
  EventNotificationMock();
  ...
  MOCK_METHOD0(Signal, void());       // this can be used to verify that call method was called only!
  MOCK_METHOD0(SignalAll, void());    // this can be used to verify that call method was called only!
};
